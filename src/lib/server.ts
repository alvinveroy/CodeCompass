  ...
  try {
    ...
    server.tool(
      ...
      async (params: unknown) => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-base-to-string -- Custom stringification logic handles object case correctly.
    ...
    server.tool(
      ...
      async (params: unknown) => {
        ...
        if (typeof parsedParams === 'object' && parsedParams !== null && !('query' in parsedParams && typeof parsedParams.query === 'string')) {
          ...
          // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- Controlled assignment to a Record<string, unknown> property after type checks.
          ...
          // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- Controlled reassignment of Record<string, unknown> to a compatible literal.
